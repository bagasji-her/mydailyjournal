    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://images.pexels.com/photos/2659475/pexels-photo-2659475.jpeg?auto=compress&cs=tinysrgb&w=600." class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://images.pexels.com/photos/2166559/pexels-photo-2166559.jpeg?auto=compress&cs=tinysrgb&w=600" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/2126389/pexels-photo-2126389.jpeg?auto=compress&cs=tinysrgb&w=600" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/2583852/pexels-photo-2583852.jpeg?auto=compress&cs=tinysrgb&w=600" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/2583847/pexels-photo-2583847.jpeg?auto=compress&cs=tinysrgb&w=600" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Rekayasa Perangkat Lunak<br />12.30-15.00 | H.5.12
                </li>
              </ul>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Pendidikan Kewarganegaraan<br />12.30-14.00 | AULA E.3.1
                </li>
              </ul>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  Probabilitas Statistik<br />09.30-12.00 | H.4.8
                </li>
                <li class="list-group-item">
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Sistem Operasi<br />12.30-15.00 | H.4.11
                </li>
              </ul>
            </div>
          </div>
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEimLbBlVXEhJN8nZWq8pDP8Cv0Yq_kQYphhYwHHL7ey3BdQIWlBFfEG-Lkv1Xn5mp7SLMwkOMnK8BsTGvFL5LW7E1WLn9wjBmDgQJn4cXz3er7n8Cewvj3454h8AGpR2E_EI8E-XX5MekNVYVQHtCOA45LLDeu2hlYNMCAjbmNh0ONVoH7aGxvuI7oDAWEw/s320/IMG_20231109_193620_812.jpg"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15355</h3>
            <h1 class="fw-bold">Bagas Aji Herlambang</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/bagasji_/profilecard/?igsh=MXNwcTM1ZDA2dmh2bQ=="
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://x.com/Imprealisme?t=f9rIdg4DO46LbOLBipPDrw&s=09"
          ><i class="bi bi-twitter h2 p-2"></i
        ></a>
        <a href="https://wa.me/+6282195949724"
